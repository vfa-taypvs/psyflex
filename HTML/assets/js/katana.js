...
var $html = $('html');
var $home = $('#home');
var $home_mobile = $('#home_mobile');
var $menu_desktop = $('.panel');
...
if(window.isMobile){$home.remove();} else {$home_mobile.remove();}
if(window.isMobile){$menu_desktop.remove();}
...
$(document).ready(function() {
  // $('#menu-color').clipthru({autoUpdate: true, autoUpdateInterval: 300,});
  ...
  //        */
  //        mobileWidth: 1024,
  //        title: '<img src="assets/img/logo.png" width="40px" style="margin-top: 10px;">',
  //       /**
  ...
  $.protip();
  // $("#mobile_menu").mmenu({
  //   // extensions: ["effect-zoom-panels"],
  //     // "iconPanels": true,
  //     "navbars": [
  //     {
  //       "position": "bottom",
  //      "content": [
  //      "<a class='fab fa-facebook-f' href='http://wwww.facebook.com/Kantanapostproduction'></a>",
  //      "<a class='fab fa-vimeo-v' href='https://vimeo.com/user17666831'></a>",
  ...
  $('.menu_mobile').click(function(e) {
    if ($('.navi').hasClass('navi-on')) {
      $('.navi').removeClass('navi-on');
      $('.navi').css('margin-right', -320);
    } else {
      $('.navi').addClass('navi-on');
      $('.navi').css('margin-right', 0);
    }
    e.preventDefault();
  })
...
$(document).ready(function() {
  $('body')
  .prepend('<div class="vidcover2"></div>')
  .hover (
    function() {
      $('.vidcover2').css({'opacity':'0.4'})
    },
    function() {
      $('.vidcover2').css({'opacity':'0'})
    }
    );
  ...
  $(window).resize( function(){
    ...
    if ( (theWidth > 1280) && (newHeight > theHeight )) {
      $('.fullvid2').css({'width':theWidth, 'height':newHeight});
    }

    if ( (theHeight > 720) && (newWidth > theWidth )) {
      $('.fullvid2').css({'height':theHeight, 'width':newWidth});
    }

    $('.vidcover2').css({'height':theHeight, 'width':theWidth});
  }).resize();
});
 // Start midnight
 $(document).ready(function(){
