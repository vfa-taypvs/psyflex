...
$lang['content'] = '<h1>Politique de Confidentialité</h1>


<p>Date de prise d\'effet: October 05, 2018</p>


<p>Psyflex ("nous", "notre", "nos") exploite le site web http://psyflex.fr (ci-après désigné par le terme "Service").</p>

<p>Cette page vous explique nos politiques en matière de collecte, d\'utilisation et de communication des données à caractère personnel lorsque vous utilisez notre Service ainsi que les choix qui s\'offrent à vous en ce qui concerne ces données. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Politique de Confidentialité via Free Privacy Policy</a>.</p>

<p>Nous utilisons vos données pour fournir et améliorer le Service. En utilisant le Service, vous consentez à la collecte et à l\'utilisation d\'informations conformément à la présente politique. Sauf définition contraire dans la présente Politique de Confidentialité, les termes utilisés dans la présente Politique de Confidentialité ont la même signification que dans nos Conditions Générales qui sont disponibles sur http://psyflex.fr</p>

<h2>Définitions</h2>
<ul>
    <li>
        <p><strong>Service</strong></p>
                <p>Par Service on entend le site web http://psyflex.fr exploité par Psyflex</p>
            </li>
    <li>
...
<p>Psyflex utilise les données recueillies à des fins diverses:</p>
<ul>
...
<p>Si vous résidez hors de/du Viet Nam et que vous choisissez de nous communiquer des informations, sachez que nous transférons les données, y compris les Données à Caractère Personnel, vers le/la Viet Nam et que nous les y traitons.</p>
...
<ul>
        <li>Par courrier électronique: psyflex2.0@gmail.com</li>
