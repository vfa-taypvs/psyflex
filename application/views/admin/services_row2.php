          ...
          ?>
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
                ...
                if (count($services) > 0) {
                  for ($i = 0 ; $i < count($services); $i ++) {
                    if ($services[$i]['video']==null){
                      ...
                      echo '<form action="adminservicesrow2/change" method="post" enctype="multipart/form-data">';
                      ...
                      echo '<a href="adminservicesrow2/delete?id='. $cipherID .'&image='.$cipherImage.'"><button type="button" class="btn btn-primary">Delete</button></a>';
                      echo '</div>';
                      echo '</form>';
                      echo '-------------------------------';
                    }
                ...
                <form action="adminservicesrow2/add" method="post" enctype="multipart/form-data">
